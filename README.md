...
- **Non-release builds with crimage are very slow** - image processing will
  take noticeably longer
- **Release builds with crimage are somewhat faster** - but still slower
  than libvips
- **Static builds require `-Dnovips`** - otherwise linking will fail due to
  missing libvips static libraries
